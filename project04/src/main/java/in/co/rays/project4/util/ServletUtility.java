...
import in.co.rays.project4.model.BaseModel;
...
public class ServletUtility {
	...
	/*
	 * public static void setUserModel(UserModel model, HttpServletRequest
	 * request) { request.getSession().setAttribute("user", model); }
	 */
	/**
	 ...
	 * model = (UserModel) request.getSession().getAttribute("user"); return
	 * model != null; }
	 */
	/**
